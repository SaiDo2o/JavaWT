...
<div class="container">
    <form action="user" class="form-signin form-signin-size " method="post">
        <div class="login-form">
            ...
            <h2 class="form-signin-heading">User Table page</h2>
            <c:if test="${msg!=null}">
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-sm-9 col-xs-9">
                    <select name="roleName">
                        <c:forEach var="tableNumList" items="${tableNumList}">
                            <option value="${tableNumList}"><c:out value="${tableNumList}"></c:out></option>
                        </c:forEach>
                    </select>
                </div>    
            </div><br>
